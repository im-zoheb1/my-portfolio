    ...
    <div class="container">
      ...
      <div data-aos="fade-down" class="features__cards">
        <div class="features__card-item">
          ...
          <h3 class="features__card--title heading--secondary">responsive</h3>
          <div class="features__card--paragraph paragraph--normal">
        ...
        <div class="features__card-item">
          ...
          >
            <path
              ...
              fill="#626262"
            />
            <rect x="0" y="0" width="10" height="10" fill="rgba(0, 0, 0, 0)" />
          </svg>
          <h3 class="features__card--title heading--secondary">
            user friendly
          </h3>
          <div class="features__card--paragraph paragraph--normal">
        ...
        <div class="features__card-item">
          ...
          <h3 class="features__card--title heading--secondary">compatible</h3>
          <div class="features__card--paragraph paragraph--normal">
            My websites are cross browser compatible
          </div>
        </div>
      </div>
    </div>
